                    ...
                    <div class="w-full flex-1 mt-6">
                        ...
                        <div class="mt-4 mb-6 border-b text-center">
                            <div
                                ...
                                O crea tu cuenta con <b>correo electrónico</b>
                            </div>
                        </div>

                        <x-validation-errors class="mb-4"/>

                        <form class="mx-auto max-w-xs flex flex-col gap-3" method="POST"
