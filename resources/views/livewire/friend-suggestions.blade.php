<div class="w-full bg-white dark:bg-gray-800">
    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Personas que quizás conozcas</h5>
    <div>
            ...
            <div class="py-4 flex gap-3 items-center" wire:key="{{uniqid()}}">
                ...
                <div class="w-full flex flex-col gap-1">
                    ...
                    <div class="flex gap-2 w-full items-center justify-between">
                        <button
                            wire:click="sendFriendRequest({{$user}})"
                            type="button"
                        ...
                        <button
                            wire:click="removeFriendSuggestion({{$user}})"
                            type="button"
        ...
        @empty
            <h2 class="text-gray-300 font-bold text-center my-2 text-xl">No hay sugerencias</h2>
        @endforelse
    </div>
</div>
